The [Email Confirmation](http://profilepress.net/downloads/email-confirmation/) ProfilePress extension ensure users confirm their registered email address before they are able to log in to WordPress.
