Let's see how [ProfilePress](profilepress.net/pricing/) will make the registration form below into a working WordPress form for registering users.
...
A [live demo](http://profilepress.net/demos/memories-registration-form/) of this login form is available [here](http://profilepress.net/demos/memories-registration-form/).
