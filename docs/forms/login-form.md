...
**Note:** Error messages generated by login forms powered by ProfilePress are wrapped in a `div` class `<div class="profilepress-login-status">` thus the CSS class in the login stylesheet.
